...
let body = new GmoAozoraNetBankOpenApi.SpAccountTransferRequest('depositSpAccountId_example', 'debitSpAccountId_example', '100'); // SpAccountTransferRequest | HTTPリクエストボディ
