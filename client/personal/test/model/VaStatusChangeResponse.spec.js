...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.VaStatusChangeResponse();
  });
  ...
  describe('VaStatusChangeResponse', function() {
    it('should create an instance of VaStatusChangeResponse', function() {
      // uncomment below and update the code to test VaStatusChangeResponse
      //var instance = new GmoAozoraNetBankOpenApi.VaStatusChangeResponse();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.VaStatusChangeResponse);
    });
