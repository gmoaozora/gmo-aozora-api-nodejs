...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.TransferAccept();
  });
  ...
  describe('TransferAccept', function() {
    it('should create an instance of TransferAccept', function() {
      // uncomment below and update the code to test TransferAccept
      //var instance = new GmoAozoraNetBankOpenApi.TransferAccept();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.TransferAccept);
    });

    it('should have the property acceptNo (base name: "acceptNo")', function() {
      // uncomment below and update the code to test the property acceptNo
      //var instance = new GmoAozoraNetBankOpenApi.TransferAccept();
