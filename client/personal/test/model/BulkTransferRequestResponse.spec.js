...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.BulkTransferRequestResponse();
  });
  ...
  describe('BulkTransferRequestResponse', function() {
    it('should create an instance of BulkTransferRequestResponse', function() {
      // uncomment below and update the code to test BulkTransferRequestResponse
      //var instance = new GmoAozoraNetBankOpenApi.BulkTransferRequestResponse();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.BulkTransferRequestResponse);
    });
