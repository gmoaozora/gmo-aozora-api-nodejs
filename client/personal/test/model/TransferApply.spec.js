...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.TransferApply();
  });
  ...
  describe('TransferApply', function() {
    it('should create an instance of TransferApply', function() {
      // uncomment below and update the code to test TransferApply
      //var instance = new GmoAozoraNetBankOpenApi.TransferApply();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.TransferApply);
    });
    ...
    it('should have the property transferApplyDetails (base name: "transferApplyDetails")', function() {
      // uncomment below and update the code to test the property transferApplyDetails
      //var instance = new GmoAozoraNetBankOpenApi.TransferApply();
      //expect(instance).to.be();
    });
