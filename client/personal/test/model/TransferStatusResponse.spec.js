...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.TransferStatusResponse();
  });
  ...
  describe('TransferStatusResponse', function() {
    it('should create an instance of TransferStatusResponse', function() {
      // uncomment below and update the code to test TransferStatusResponse
      //var instance = new GmoAozoraNetBankOpenApi.TransferStatusResponse();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.TransferStatusResponse);
    });
    ...
    it('should have the property transferDetails (base name: "transferDetails")', function() {
      // uncomment below and update the code to test the property transferDetails
      //var instance = new GmoAozoraNetBankOpenApi.TransferStatusResponse();
      //expect(instance).to.be();
    });
