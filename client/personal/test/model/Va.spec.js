...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.Va();
  });
  ...
  describe('Va', function() {
    it('should create an instance of Va', function() {
      // uncomment below and update the code to test Va
      //var instance = new GmoAozoraNetBankOpenApi.Va();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.Va);
    });
