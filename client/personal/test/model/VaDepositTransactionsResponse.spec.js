...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.VaDepositTransactionsResponse();
  });
  ...
  describe('VaDepositTransactionsResponse', function() {
    it('should create an instance of VaDepositTransactionsResponse', function() {
      // uncomment below and update the code to test VaDepositTransactionsResponse
      //var instance = new GmoAozoraNetBankOpenApi.VaDepositTransactionsResponse();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.VaDepositTransactionsResponse);
    });
    ...
    it('should have the property vaTransactions (base name: "vaTransactions")', function() {
      // uncomment below and update the code to test the property vaTransactions
      //var instance = new GmoAozoraNetBankOpenApi.VaDepositTransactionsResponse();
      //expect(instance).to.be();
    });
