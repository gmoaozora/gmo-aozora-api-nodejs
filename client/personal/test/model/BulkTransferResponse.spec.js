...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.BulkTransferResponse();
  });
  ...
  describe('BulkTransferResponse', function() {
    it('should create an instance of BulkTransferResponse', function() {
      // uncomment below and update the code to test BulkTransferResponse
      //var instance = new GmoAozoraNetBankOpenApi.BulkTransferResponse();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.BulkTransferResponse);
    });
    ...
    it('should have the property bulkTransferInfos (base name: "bulkTransferInfos")', function() {
      // uncomment below and update the code to test the property bulkTransferInfos
      //var instance = new GmoAozoraNetBankOpenApi.BulkTransferResponse();
      //expect(instance).to.be();
    });
