...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.TransferResponse();
  });
  ...
  describe('TransferResponse', function() {
    it('should create an instance of TransferResponse', function() {
      ...
      //var instance = new GmoAozoraNetBankOpenApi.TransferResponse();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.TransferResponse);
    });
    ...
    it('should have the property transferInfos (base name: "transferInfos")', function() {
      // uncomment below and update the code to test the property transferInfos
      //var instance = new GmoAozoraNetBankOpenApi.TransferResponse();
      //expect(instance).to.be();
    });
