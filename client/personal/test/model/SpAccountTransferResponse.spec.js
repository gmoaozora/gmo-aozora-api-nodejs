...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.SpAccountTransferResponse();
  });
  ...
  describe('SpAccountTransferResponse', function() {
    it('should create an instance of SpAccountTransferResponse', function() {
      // uncomment below and update the code to test SpAccountTransferResponse
      //var instance = new GmoAozoraNetBankOpenApi.SpAccountTransferResponse();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.SpAccountTransferResponse);
    });

    it('should have the property acceptDatetime (base name: "acceptDatetime")', function() {
      // uncomment below and update the code to test the property acceptDatetime
      //var instance = new GmoAozoraNetBankOpenApi.SpAccountTransferResponse();
      //expect(instance).to.be();
    });

    it('should have the property depositSpAccountId (base name: "depositSpAccountId")', function() {
      // uncomment below and update the code to test the property depositSpAccountId
      //var instance = new GmoAozoraNetBankOpenApi.SpAccountTransferResponse();
      //expect(instance).to.be();
    });

    it('should have the property debitSpAccountId (base name: "debitSpAccountId")', function() {
      // uncomment below and update the code to test the property debitSpAccountId
      //var instance = new GmoAozoraNetBankOpenApi.SpAccountTransferResponse();
      //expect(instance).to.be();
    });
