...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.BalancesResponse();
  });
  ...
  describe('BalancesResponse', function() {
    it('should create an instance of BalancesResponse', function() {
      // uncomment below and update the code to test BalancesResponse
      //var instance = new GmoAozoraNetBankOpenApi.BalancesResponse();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.BalancesResponse);
    });
    ...
    it('should have the property spAccountBalances (base name: "spAccountBalances")', function() {
      // uncomment below and update the code to test the property spAccountBalances
      //var instance = new GmoAozoraNetBankOpenApi.BalancesResponse();
      //expect(instance).to.be();
    });
