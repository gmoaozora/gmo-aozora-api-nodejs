...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.SpAccountTransferRequest();
  });
  ...
  describe('SpAccountTransferRequest', function() {
    it('should create an instance of SpAccountTransferRequest', function() {
      // uncomment below and update the code to test SpAccountTransferRequest
      //var instance = new GmoAozoraNetBankOpenApi.SpAccountTransferRequest();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.SpAccountTransferRequest);
    });
