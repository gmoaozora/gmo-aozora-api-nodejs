...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.Transaction();
  });
  ...
  describe('Transaction', function() {
    it('should create an instance of Transaction', function() {
      ...
      //var instance = new GmoAozoraNetBankOpenApi.Transaction();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.Transaction);
    });
