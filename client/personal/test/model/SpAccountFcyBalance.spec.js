...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.SpAccountFcyBalance();
  });
  ...
  describe('SpAccountFcyBalance', function() {
    it('should create an instance of SpAccountFcyBalance', function() {
      // uncomment below and update the code to test SpAccountFcyBalance
      //var instance = new GmoAozoraNetBankOpenApi.SpAccountFcyBalance();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.SpAccountFcyBalance);
    });
