...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.SpAccountBalance();
  });
  ...
  describe('SpAccountBalance', function() {
    it('should create an instance of SpAccountBalance', function() {
      // uncomment below and update the code to test SpAccountBalance
      //var instance = new GmoAozoraNetBankOpenApi.SpAccountBalance();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.SpAccountBalance);
    });
    ...
    it('should have the property odBalance (base name: "odBalance")', function() {
      // uncomment below and update the code to test the property odBalance
      //var instance = new GmoAozoraNetBankOpenApi.SpAccountBalance();
      //expect(instance).to.be();
    });

    it('should have the property tdTotalBalance (base name: "tdTotalBalance")', function() {
      // uncomment below and update the code to test the property tdTotalBalance
      //var instance = new GmoAozoraNetBankOpenApi.SpAccountBalance();
      //expect(instance).to.be();
    });

    it('should have the property fodTotalBalanceYenEquivalent (base name: "fodTotalBalanceYenEquivalent")', function() {
      // uncomment below and update the code to test the property fodTotalBalanceYenEquivalent
      //var instance = new GmoAozoraNetBankOpenApi.SpAccountBalance();
      //expect(instance).to.be();
    });

    it('should have the property spAccountFcyBalances (base name: "spAccountFcyBalances")', function() {
      // uncomment below and update the code to test the property spAccountFcyBalances
      //var instance = new GmoAozoraNetBankOpenApi.SpAccountBalance();
      //expect(instance).to.be();
    });
