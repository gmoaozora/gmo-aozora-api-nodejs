...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.ErrorDetail();
  });
  ...
  describe('ErrorDetail', function() {
    it('should create an instance of ErrorDetail', function() {
      ...
      //var instance = new GmoAozoraNetBankOpenApi.ErrorDetail();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.ErrorDetail);
    });

    it('should have the property errorDetailsCode (base name: "errorDetailsCode")', function() {
      // uncomment below and update the code to test the property errorDetailsCode
      //var instance = new GmoAozoraNetBankOpenApi.ErrorDetail();
      //expect(instance).to.be();
    });

    it('should have the property errorDetailsMessage (base name: "errorDetailsMessage")', function() {
      // uncomment below and update the code to test the property errorDetailsMessage
      //var instance = new GmoAozoraNetBankOpenApi.ErrorDetail();
      //expect(instance).to.be();
    });
