...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.Balance();
  });
  ...
  describe('Balance', function() {
    it('should create an instance of Balance', function() {
      ...
      //var instance = new GmoAozoraNetBankOpenApi.Balance();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.Balance);
    });
    ...
    it('should have the property withdrawableAmount (base name: "withdrawableAmount")', function() {
      // uncomment below and update the code to test the property withdrawableAmount
      //var instance = new GmoAozoraNetBankOpenApi.Balance();
      //expect(instance).to.be();
    });

    it('should have the property previousDayBalance (base name: "previousDayBalance")', function() {
      // uncomment below and update the code to test the property previousDayBalance
      //var instance = new GmoAozoraNetBankOpenApi.Balance();
      //expect(instance).to.be();
    });

    it('should have the property previousMonthBalance (base name: "previousMonthBalance")', function() {
      // uncomment below and update the code to test the property previousMonthBalance
      //var instance = new GmoAozoraNetBankOpenApi.Balance();
      //expect(instance).to.be();
    });
    ...
    it('should have the property fcyTotalBalance (base name: "fcyTotalBalance")', function() {
      // uncomment below and update the code to test the property fcyTotalBalance
      //var instance = new GmoAozoraNetBankOpenApi.Balance();
      //expect(instance).to.be();
    });

    it('should have the property ttb (base name: "ttb")', function() {
      // uncomment below and update the code to test the property ttb
      //var instance = new GmoAozoraNetBankOpenApi.Balance();
      //expect(instance).to.be();
    });

    it('should have the property baseRateDate (base name: "baseRateDate")', function() {
      // uncomment below and update the code to test the property baseRateDate
      //var instance = new GmoAozoraNetBankOpenApi.Balance();
      //expect(instance).to.be();
    });

    it('should have the property baseRateTime (base name: "baseRateTime")', function() {
      // uncomment below and update the code to test the property baseRateTime
      //var instance = new GmoAozoraNetBankOpenApi.Balance();
      //expect(instance).to.be();
    });

    it('should have the property yenEquivalent (base name: "yenEquivalent")', function() {
      // uncomment below and update the code to test the property yenEquivalent
      //var instance = new GmoAozoraNetBankOpenApi.Balance();
      //expect(instance).to.be();
    });
