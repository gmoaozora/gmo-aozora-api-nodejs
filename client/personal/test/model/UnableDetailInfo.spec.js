...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.UnableDetailInfo();
  });
  ...
  describe('UnableDetailInfo', function() {
    it('should create an instance of UnableDetailInfo', function() {
      // uncomment below and update the code to test UnableDetailInfo
      //var instance = new GmoAozoraNetBankOpenApi.UnableDetailInfo();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.UnableDetailInfo);
    });

    it('should have the property transferDetailStatus (base name: "transferDetailStatus")', function() {
      // uncomment below and update the code to test the property transferDetailStatus
      //var instance = new GmoAozoraNetBankOpenApi.UnableDetailInfo();
    ...
    it('should have the property isRepayment (base name: "isRepayment")', function() {
      // uncomment below and update the code to test the property isRepayment
      //var instance = new GmoAozoraNetBankOpenApi.UnableDetailInfo();
      //expect(instance).to.be();
    });

    it('should have the property repaymentDate (base name: "repaymentDate")', function() {
      // uncomment below and update the code to test the property repaymentDate
      //var instance = new GmoAozoraNetBankOpenApi.UnableDetailInfo();
      //expect(instance).to.be();
    });
