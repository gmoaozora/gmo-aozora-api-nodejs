...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.AccountsResponse();
  });
  ...
  describe('AccountsResponse', function() {
    it('should create an instance of AccountsResponse', function() {
      ...
      //var instance = new GmoAozoraNetBankOpenApi.AccountsResponse();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.AccountsResponse);
    });
    ...
    it('should have the property spAccounts (base name: "spAccounts")', function() {
      // uncomment below and update the code to test the property spAccounts
      //var instance = new GmoAozoraNetBankOpenApi.AccountsResponse();
      //expect(instance).to.be();
    });
