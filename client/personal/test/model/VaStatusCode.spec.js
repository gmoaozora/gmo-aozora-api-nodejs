...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.VaStatusCode();
  });
  ...
  describe('VaStatusCode', function() {
    it('should create an instance of VaStatusCode', function() {
      // uncomment below and update the code to test VaStatusCode
      //var instance = new GmoAozoraNetBankOpenApi.VaStatusCode();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.VaStatusCode);
    });
