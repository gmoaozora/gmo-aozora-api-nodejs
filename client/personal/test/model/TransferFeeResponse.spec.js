...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.TransferFeeResponse();
  });
  ...
  describe('TransferFeeResponse', function() {
    it('should create an instance of TransferFeeResponse', function() {
      // uncomment below and update the code to test TransferFeeResponse
      //var instance = new GmoAozoraNetBankOpenApi.TransferFeeResponse();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.TransferFeeResponse);
    });
    ...
    it('should have the property transferFeeDetails (base name: "transferFeeDetails")', function() {
      // uncomment below and update the code to test the property transferFeeDetails
      //var instance = new GmoAozoraNetBankOpenApi.TransferFeeResponse();
      //expect(instance).to.be();
    });
