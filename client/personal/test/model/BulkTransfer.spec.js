...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.BulkTransfer();
  });
  ...
  describe('BulkTransfer', function() {
    it('should create an instance of BulkTransfer', function() {
      // uncomment below and update the code to test BulkTransfer
      //var instance = new GmoAozoraNetBankOpenApi.BulkTransfer();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.BulkTransfer);
    });
