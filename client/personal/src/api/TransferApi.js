...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorResponse', 'model/SpAccountTransferRequest', 'model/SpAccountTransferResponse', 'model/TransferCancelRequest', 'model/TransferCancelResponse', 'model/TransferError', 'model/TransferFeeResponse', 'model/TransferRequest', 'model/TransferRequestResponse', 'model/TransferRequestResultResponse', 'model/TransferStatusResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorResponse'), require('../model/SpAccountTransferRequest'), require('../model/SpAccountTransferResponse'), require('../model/TransferCancelRequest'), require('../model/TransferCancelResponse'), require('../model/TransferError'), require('../model/TransferFeeResponse'), require('../model/TransferRequest'), require('../model/TransferRequestResponse'), require('../model/TransferRequestResultResponse'), require('../model/TransferStatusResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.GmoAozoraNetBankOpenApi) {
      root.GmoAozoraNetBankOpenApi = {};
    }
    root.GmoAozoraNetBankOpenApi.TransferApi = factory(root.GmoAozoraNetBankOpenApi.ApiClient, root.GmoAozoraNetBankOpenApi.ErrorResponse, root.GmoAozoraNetBankOpenApi.SpAccountTransferRequest, root.GmoAozoraNetBankOpenApi.SpAccountTransferResponse, root.GmoAozoraNetBankOpenApi.TransferCancelRequest, root.GmoAozoraNetBankOpenApi.TransferCancelResponse, root.GmoAozoraNetBankOpenApi.TransferError, root.GmoAozoraNetBankOpenApi.TransferFeeResponse, root.GmoAozoraNetBankOpenApi.TransferRequest, root.GmoAozoraNetBankOpenApi.TransferRequestResponse, root.GmoAozoraNetBankOpenApi.TransferRequestResultResponse, root.GmoAozoraNetBankOpenApi.TransferStatusResponse);
  }
}(this, function(ApiClient, ErrorResponse, SpAccountTransferRequest, SpAccountTransferResponse, TransferCancelRequest, TransferCancelResponse, TransferError, TransferFeeResponse, TransferRequest, TransferRequestResponse, TransferRequestResultResponse, TransferStatusResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the spAccountTransferUsingPOST operation.
     * @callback module:api/TransferApi~spAccountTransferUsingPOSTCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SpAccountTransferResponse} data The data returned by the service call.
     ...
     * @param {module:model/SpAccountTransferRequest} body HTTPリクエストボディ
     * @param {String} xAccessToken アクセストークン  minLength: 1 maxLength: 128 
     * @param {module:api/TransferApi~spAccountTransferUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SpAccountTransferResponse}
     */
    this.spAccountTransferUsingPOST = function(body, xAccessToken, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling spAccountTransferUsingPOST");
      }

      // verify the required parameter 'xAccessToken' is set
      if (xAccessToken === undefined || xAccessToken === null) {
        throw new Error("Missing the required parameter 'xAccessToken' when calling spAccountTransferUsingPOST");
      }
      ...
      var returnType = SpAccountTransferResponse;

      return this.apiClient.callApi(
        '/transfer/spaccounts-transfer', 'POST',
     ...
     * @param {String} opts.requestTransferClass 振込照会対象取得区分 半角数字 1：ALL、2：振込申請のみ、3：振込受付情報のみ NULLを設定 （値が設定されている場合は、「400 Bad Request」を返却）  minLength: 1 maxLength: 1 
