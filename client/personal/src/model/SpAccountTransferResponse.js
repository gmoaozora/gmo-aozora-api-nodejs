...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GmoAozoraNetBankOpenApi.SpAccountTransferResponse = factory(root.GmoAozoraNetBankOpenApi.ApiClient);
  }
  ...
  /**
   * The SpAccountTransferResponse model module.
   * @module model/SpAccountTransferResponse
   * @version 1.1.12
   */

  /**
   * Constructs a new <code>SpAccountTransferResponse</code>.
   * @alias module:model/SpAccountTransferResponse
   * @class
   * @param depositSpAccountId {String} つかいわけ口座_入金口座ID 半角数字 口座を識別するID　入金先となる口座情報 
   * @param debitSpAccountId {String} つかいわけ口座_出金口座ID 半角数字 口座を識別するID　引き落とし元となる口座情報 
   */
  var exports = function(depositSpAccountId, debitSpAccountId) {
    var _this = this;


    _this['depositSpAccountId'] = depositSpAccountId;
    _this['debitSpAccountId'] = debitSpAccountId;
  ...
  /**
   * Constructs a <code>SpAccountTransferResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SpAccountTransferResponse} obj Optional instance to populate.
   * @return {module:model/SpAccountTransferResponse} The populated <code>SpAccountTransferResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('acceptDatetime')) {
        obj['acceptDatetime'] = ApiClient.convertToType(data['acceptDatetime'], 'String');
      }
      if (data.hasOwnProperty('depositSpAccountId')) {
        obj['depositSpAccountId'] = ApiClient.convertToType(data['depositSpAccountId'], 'String');
      }
      if (data.hasOwnProperty('debitSpAccountId')) {
        obj['debitSpAccountId'] = ApiClient.convertToType(data['debitSpAccountId'], 'String');
      }
   ...
   * @member {String} acceptDatetime
   */
  exports.prototype['acceptDatetime'] = undefined;
  /**
   * つかいわけ口座_入金口座ID 半角数字 口座を識別するID　入金先となる口座情報 
   * @member {String} depositSpAccountId
   */
  exports.prototype['depositSpAccountId'] = undefined;
  /**
   * つかいわけ口座_出金口座ID 半角数字 口座を識別するID　引き落とし元となる口座情報 
   * @member {String} debitSpAccountId
   */
  exports.prototype['debitSpAccountId'] = undefined;
  /**
