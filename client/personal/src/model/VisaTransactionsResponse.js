...
(function(root, factory) {
...
}(this, function(ApiClient, VisaTransaction) {
  'use strict';
   ...
   * @param baseDate {String} 基準日 Visaデビット取引明細を照会した基準日を示します YYYY-MM-DD形式 
  ...
  /**
   * Constructs a <code>VisaTransaction</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VisaTransaction} obj Optional instance to populate.
   * @return {module:model/VisaTransaction} The populated <code>VisaTransaction</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('visatransactions')) {
        obj['visatransactions'] = ApiClient.convertToType(data['visatransactions'], [VisaTransaction]);
      }
   ...
   */
  exports.prototype['visatransactions'] = undefined;
