...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GmoAozoraNetBankOpenApi.VaId = factory(root.GmoAozoraNetBankOpenApi.ApiClient);
  }
  ...
  /**
   * The VaId model module.
   * @module model/VaId
   * @version 1.1.12
   */

  /**
   * Constructs a new <code>VaId</code>.
   * @alias module:model/VaId
   * @class
   * @param vaId {String} 振込入金口座ID 半角数字 振込入金口座を識別するID 
   */
  var exports = function(vaId) {
    var _this = this;
  ...
  /**
   * Constructs a <code>VaId</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VaId} obj Optional instance to populate.
   * @return {module:model/VaId} The populated <code>VaId</code> instance.
   */
