...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TransferApplyDetail'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TransferApplyDetail'));
  } else {
    // Browser globals (root is window)
    if (!root.GmoAozoraNetBankOpenApi) {
      root.GmoAozoraNetBankOpenApi = {};
    }
    root.GmoAozoraNetBankOpenApi.TransferApply = factory(root.GmoAozoraNetBankOpenApi.ApiClient, root.GmoAozoraNetBankOpenApi.TransferApplyDetail);
  }
}(this, function(ApiClient, TransferApplyDetail) {
  'use strict';
  ...
  /**
   * The TransferApply model module.
   * @module model/TransferApply
   * @version 1.1.12
   */

  /**
   * Constructs a new <code>TransferApply</code>.
   * @alias module:model/TransferApply
   * @class
   */
  ...
  /**
   * Constructs a <code>TransferApply</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransferApply} obj Optional instance to populate.
   * @return {module:model/TransferApply} The populated <code>TransferApply</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('transferApplyDetails')) {
        obj['transferApplyDetails'] = ApiClient.convertToType(data['transferApplyDetails'], [TransferApplyDetail]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/TransferApplyDetail>} transferApplyDetails
   */
  exports.prototype['transferApplyDetails'] = undefined;
