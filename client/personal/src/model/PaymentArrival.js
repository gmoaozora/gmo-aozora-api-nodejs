...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GmoAozoraNetBankOpenApi.PaymentArrival = factory(root.GmoAozoraNetBankOpenApi.ApiClient);
  }
  ...
  /**
   * The PaymentArrival model module.
   * @module model/PaymentArrival
   * @version 1.1.12
   */

  /**
   * Constructs a new <code>PaymentArrival</code>.
   * @alias module:model/PaymentArrival
   * @class
   * @param transactionDate {String} 取引日 半角文字 YYYY-MM-DD形式 
   * @param valueDate {String} 起算日 半角文字 YYYY-MM-DD形式 
   * @param transactionType {String} 入払コード 半角数字 ・1=入金 ・2=出金 常に1=入金のみ 
   * @param amount {String} 取引金額 半角数字　マイナス含む 
   * @param itemKey {String} 明細キー 半角数字 口座ID毎に設定される明細キー（明細データtimestamp（μs）） 
   */
  var exports = function(transactionDate, valueDate, transactionType, amount, itemKey) {
    var _this = this;
  ...
  /**
   * Constructs a <code>PaymentArrival</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentArrival} obj Optional instance to populate.
   * @return {module:model/PaymentArrival} The populated <code>PaymentArrival</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('applicantName')) {
        obj['applicantName'] = ApiClient.convertToType(data['applicantName'], 'String');
      }
   ...
   */
  exports.prototype['applicantName'] = undefined;
  /**
   * 仕向金融機関名カナ 半角文字 
