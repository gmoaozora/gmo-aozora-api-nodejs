...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TransferInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TransferInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.GmoAozoraNetBankOpenApi) {
      root.GmoAozoraNetBankOpenApi = {};
    }
    root.GmoAozoraNetBankOpenApi.TransferResponse = factory(root.GmoAozoraNetBankOpenApi.ApiClient, root.GmoAozoraNetBankOpenApi.TransferInfo);
  }
}(this, function(ApiClient, TransferInfo) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('transferInfos')) {
        obj['transferInfos'] = ApiClient.convertToType(data['transferInfos'], [TransferInfo]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/TransferInfo>} transferInfos
   */
  exports.prototype['transferInfos'] = undefined;
