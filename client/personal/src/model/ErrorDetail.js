...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GmoAozoraNetBankOpenApi.ErrorDetail = factory(root.GmoAozoraNetBankOpenApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('errorDetailsCode')) {
        obj['errorDetailsCode'] = ApiClient.convertToType(data['errorDetailsCode'], 'String');
      }
      if (data.hasOwnProperty('errorDetailsMessage')) {
        obj['errorDetailsMessage'] = ApiClient.convertToType(data['errorDetailsMessage'], 'String');
      }
    }
    return obj;
  }
   ...
   * @member {String} errorDetailsCode
   */
  exports.prototype['errorDetailsCode'] = undefined;
  /**
   * エラー詳細内容 全半角英数記号文字 エラー詳細コードに紐付くメッセージ 
   * @member {String} errorDetailsMessage
   */
  exports.prototype['errorDetailsMessage'] = undefined;
