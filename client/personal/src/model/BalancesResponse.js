...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Balance', 'model/SpAccountBalance'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Balance'), require('./SpAccountBalance'));
  } else {
    // Browser globals (root is window)
    if (!root.GmoAozoraNetBankOpenApi) {
      root.GmoAozoraNetBankOpenApi = {};
    }
    root.GmoAozoraNetBankOpenApi.BalancesResponse = factory(root.GmoAozoraNetBankOpenApi.ApiClient, root.GmoAozoraNetBankOpenApi.Balance, root.GmoAozoraNetBankOpenApi.SpAccountBalance);
  }
}(this, function(ApiClient, Balance, SpAccountBalance) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('spAccountBalances')) {
        obj['spAccountBalances'] = ApiClient.convertToType(data['spAccountBalances'], [SpAccountBalance]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/SpAccountBalance>} spAccountBalances
   */
  exports.prototype['spAccountBalances'] = undefined;
