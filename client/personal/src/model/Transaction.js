...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GmoAozoraNetBankOpenApi.Transaction = factory(root.GmoAozoraNetBankOpenApi.ApiClient);
  }
   ...
   * @param transactionType {String} 入払コード 半角数字 ・1=入金 ・2=出金 
   * @param amount {String} 取引金額 半角数字　マイナス含む 
   * @param balance {String} 取引後残高 半角数字　マイナス含む 
   */
  var exports = function(transactionDate, valueDate, transactionType, amount, balance) {
    var _this = this;
