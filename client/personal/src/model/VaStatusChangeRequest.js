...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/VaId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./VaId'));
  } else {
    // Browser globals (root is window)
    if (!root.GmoAozoraNetBankOpenApi) {
      root.GmoAozoraNetBankOpenApi = {};
    }
    root.GmoAozoraNetBankOpenApi.VaStatusChangeRequest = factory(root.GmoAozoraNetBankOpenApi.ApiClient, root.GmoAozoraNetBankOpenApi.VaId);
  }
}(this, function(ApiClient, VaId) {
  'use strict';
  ...
  /**
   * The VaStatusChangeRequest model module.
   * @module model/VaStatusChangeRequest
   * @version 1.1.12
   */

  /**
   * Constructs a new <code>VaStatusChangeRequest</code>.
   * @alias module:model/VaStatusChangeRequest
   * @class
   * @param vaStatusChangeCode {String} 振込入金口座状態変更依頼コード 半角数字 以下の変更したコード値を設定 ・1=停止 ・2=再開 ・3=削除 
   * @param vaIdList {Array.<module:model/VaId>} 振込入金口座IDリスト 上限は100件 
   */
  var exports = function(vaStatusChangeCode, vaIdList) {
    var _this = this;


    _this['vaStatusChangeCode'] = vaStatusChangeCode;
    _this['vaIdList'] = vaIdList;
  };

  /**
   * Constructs a <code>VaStatusChangeRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VaStatusChangeRequest} obj Optional instance to populate.
   * @return {module:model/VaStatusChangeRequest} The populated <code>VaStatusChangeRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('vaStatusChangeCode')) {
        obj['vaStatusChangeCode'] = ApiClient.convertToType(data['vaStatusChangeCode'], 'String');
      }
   ...
   * @member {String} vaStatusChangeCode
   */
  exports.prototype['vaStatusChangeCode'] = undefined;
  /**
   * 振込入金口座IDリスト 上限は100件 
