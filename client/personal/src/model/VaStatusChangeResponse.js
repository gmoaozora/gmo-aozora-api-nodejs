...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GmoAozoraNetBankOpenApi.VaStatusChangeResponse = factory(root.GmoAozoraNetBankOpenApi.ApiClient, root.GmoAozoraNetBankOpenApi.VAccount);
  }
  ...
  /**
   * The VaStatusChangeResponse model module.
   * @module model/VaStatusChangeResponse
   * @version 1.1.12
   */

  /**
   * Constructs a new <code>VaStatusChangeResponse</code>.
   * @alias module:model/VaStatusChangeResponse
   * @class
   * @param vAccounts {Array.<module:model/VAccount>} 振込入金口座情報 振込入金口座情報のリスト
   */
  var exports = function(vAccounts) {
    var _this = this;

    _this['vAccounts'] = vAccounts;
  };

  /**
   * Constructs a <code>VaStatusChangeResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VaStatusChangeResponse} obj Optional instance to populate.
   * @return {module:model/VaStatusChangeResponse} The populated <code>VaStatusChangeResponse</code> instance.
   */
