...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GmoAozoraNetBankOpenApi.TransferErrorDetail = factory(root.GmoAozoraNetBankOpenApi.ApiClient, root.GmoAozoraNetBankOpenApi.ErrorDetail);
  }
  ...
  /**
   * The TransferErrorDetail model module.
   * @module model/TransferErrorDetail
   * @version 1.1.12
   */

  /**
   * Constructs a new <code>TransferErrorDetail</code>.
   * @alias module:model/TransferErrorDetail
   * @class
   */
  ...
  /**
   * Constructs a <code>TransferErrorDetail</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransferErrorDetail} obj Optional instance to populate.
   * @return {module:model/TransferErrorDetail} The populated <code>TransferErrorDetail</code> instance.
   */
