...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Va'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Va'));
  } else {
    // Browser globals (root is window)
    if (!root.GmoAozoraNetBankOpenApi) {
      root.GmoAozoraNetBankOpenApi = {};
    }
    root.GmoAozoraNetBankOpenApi.VaIssueResponse = factory(root.GmoAozoraNetBankOpenApi.ApiClient, root.GmoAozoraNetBankOpenApi.Va);
  }
}(this, function(ApiClient, Va) {
  'use strict';
  ...
  /**
   * The VaIssueResponse model module.
   * @module model/VaIssueResponse
   * @version 1.1.12
   */

  /**
   * Constructs a new <code>VaIssueResponse</code>.
   * @alias module:model/VaIssueResponse
   * @class
   * @param vaTypeCode {String} 振込入金口座　種類コード 半角数字 ・1=期限型 ・2=継続型 
   * @param vaTypeName {String} 振込入金口座　種類名 全角文字 振込入金口座　種類コードの名称 
   * @param vaHolderNameKana {String} 振込入金口座名義カナ 半角文字 
   * @param vaList {Array.<module:model/Va>} 振込入金口座リスト
   */
  var exports = function(vaTypeCode, vaTypeName, vaHolderNameKana, vaList) {
    var _this = this;
  ...
  /**
   * Constructs a <code>VaIssueResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VaIssueResponse} obj Optional instance to populate.
   * @return {module:model/VaIssueResponse} The populated <code>VaIssueResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('vaList')) {
        obj['vaList'] = ApiClient.convertToType(data['vaList'], [Va]);
      }
    }
    return obj;
  }
  ...
  /**
   * 振込入金口座リスト
   * @member {Array.<module:model/Va>} vaList
   */
  exports.prototype['vaList'] = undefined;
