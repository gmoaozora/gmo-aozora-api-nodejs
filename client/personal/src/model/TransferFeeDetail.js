...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GmoAozoraNetBankOpenApi.TransferFeeDetail = factory(root.GmoAozoraNetBankOpenApi.ApiClient);
  }
  ...
  /**
   * The TransferFeeDetail model module.
   * @module model/TransferFeeDetail
   * @version 1.1.12
   */

  /**
   * Constructs a new <code>TransferFeeDetail</code>.
   * @alias module:model/TransferFeeDetail
   * @class
   * @param itemId {String} 明細番号 半角数字 明細番号を表示 
   * @param transferFee {String} 個別振込手数料 半角数字 該当明細番号の手数料を表示 
   */
  var exports = function(itemId, transferFee) {
    var _this = this;

    _this['itemId'] = itemId;
    _this['transferFee'] = transferFee;
  };

  /**
   * Constructs a <code>TransferFeeDetail</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransferFeeDetail} obj Optional instance to populate.
   * @return {module:model/TransferFeeDetail} The populated <code>TransferFeeDetail</code> instance.
   */
