...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.DepositTransactionsResponse();
  });
  ...
  describe('DepositTransactionsResponse', function() {
    it('should create an instance of DepositTransactionsResponse', function() {
    ...
    it('should have the property paymentArrivals (base name: "paymentArrivals")', function() {
      // uncomment below and update the code to test the property paymentArrivals
      //var instance = new GmoAozoraNetBankOpenApi.DepositTransactionsResponse();
      //expect(instance).to.be();
    });
