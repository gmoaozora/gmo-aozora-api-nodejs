...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.TransactionsResponse();
  });
  ...
  describe('TransactionsResponse', function() {
    it('should create an instance of TransactionsResponse', function() {
      // uncomment below and update the code to test TransactionsResponse
      //var instance = new GmoAozoraNetBankOpenApi.TransactionsResponse();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.TransactionsResponse);
    });
