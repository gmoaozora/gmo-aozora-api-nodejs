...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmoAozoraNetBankOpenApi.TransferErrorDetail();
  });
  ...
  describe('TransferErrorDetail', function() {
    it('should create an instance of TransferErrorDetail', function() {
      // uncomment below and update the code to test TransferErrorDetail
      //var instance = new GmoAozoraNetBankOpenApi.TransferErrorDetail();
      //expect(instance).to.be.a(GmoAozoraNetBankOpenApi.TransferErrorDetail);
    });
