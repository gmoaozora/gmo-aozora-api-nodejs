...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.GmoAozoraNetBankOpenApi.Transfer = factory(root.GmoAozoraNetBankOpenApi.ApiClient);
  }
   ...
   * @class
   * @param transferAmount {String} 振込金額 半角数字 1以上、整数のみ 
   ...
   * @param beneficiaryName {String} 受取人名 半角文字 振込許容文字を指定可 ただし、一部の非許容文字は、許容文字に変換を行います 
   */
  var exports = function(transferAmount, beneficiaryBankCode, beneficiaryBranchCode, accountTypeCode, accountNumber, beneficiaryName) {
    var _this = this;
