...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TransferDetailResponse', 'model/UnableDetailInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TransferDetailResponse'), require('./UnableDetailInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.GmoAozoraNetBankOpenApi) {
      root.GmoAozoraNetBankOpenApi = {};
    }
    root.GmoAozoraNetBankOpenApi.BulkTransferInfo = factory(root.GmoAozoraNetBankOpenApi.ApiClient, root.GmoAozoraNetBankOpenApi.TransferDetailResponse, root.GmoAozoraNetBankOpenApi.UnableDetailInfo);
  }
}(this, function(ApiClient, TransferDetailResponse, UnableDetailInfo) {
  'use strict';
  ...
  /**
   * The BulkTransferInfo model module.
   * @module model/BulkTransferInfo
   * @version 1.1.12
   */

  /**
   * Constructs a new <code>BulkTransferInfo</code>.
   * @alias module:model/BulkTransferInfo
   * @class
   */
  ...
  /**
   * Constructs a <code>BulkTransferInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BulkTransferInfo} obj Optional instance to populate.
   * @return {module:model/BulkTransferInfo} The populated <code>BulkTransferInfo</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('transferDetailResponses')) {
        obj['transferDetailResponses'] = ApiClient.convertToType(data['transferDetailResponses'], [TransferDetailResponse]);
      }
      if (data.hasOwnProperty('unableDetailInfos')) {
        obj['unableDetailInfos'] = ApiClient.convertToType(data['unableDetailInfos'], [UnableDetailInfo]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/TransferDetailResponse>} transferDetailResponses
   */
  exports.prototype['transferDetailResponses'] = undefined;
  /**
   * 不能明細情報 不能明細情報のリスト 該当する情報が無い場合は項目自体を設定しません 
   * @member {Array.<module:model/UnableDetailInfo>} unableDetailInfos
   */
  exports.prototype['unableDetailInfos'] = undefined;
